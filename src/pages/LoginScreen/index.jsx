  ...
  return (
    <>
      <div className="bg-gray-50 flex sm:flex-col md:flex-col flex-row font-lexend sm:gap-5 md:gap-5 items-center mx-auto w-full">
        ...
        <div className="bg-gray-50 flex flex-col font-mulish md:gap-10 gap-[196px] items-end justify-end p-[97px] md:px-5 w-[51%] md:w-full">
          <div
            className="common-pointer bg-white-A700 border border-gray-300 border-solid flex flex-col items-start justify-start mr-3.5 mt-[63px] p-[50px] md:px-10 sm:px-5 rounded-lg shadow-bs3 w-auto sm:w-full"
            onClick={() => navigate("/loginscreenactive")}
          >
