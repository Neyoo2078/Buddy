  ...
  return (
    <>
      <div className="bg-gray-50 flex sm:flex-col md:flex-col flex-row font-lexend sm:gap-5 md:gap-5 items-center mx-auto w-full">
        ...
        <div className="bg-gray-50 flex flex-col font-mulish md:gap-10 gap-[253px] items-end justify-end p-[97px] md:px-5 w-[51%] md:w-full">
                  ...
                  <div className="flex flex-col items-start justify-start w-auto sm:w-full">
                    <div className="flex flex-col items-start justify-start w-auto sm:w-full">
                      <div className="flex flex-col gap-3 items-start justify-start w-auto sm:w-full">
                        <SignUpScreenDashboardinput
                          className="flex flex-col items-center justify-center w-auto sm:w-full"
                          googlelabeltext="Sign up with email"
                        />
                        <div className="flex sm:flex-col flex-row gap-4 items-center justify-start w-auto sm:w-full">
                          <Line className="bg-gray-300 h-px w-[45%]" />
                          <Text
                        ...
                        <SignUpScreenDashboardinput
                          className="flex flex-col items-center justify-center w-auto sm:w-full"
                          googleimage="images/img_google.svg"
                          googlelabeltext="Sign up with Google"
                        />
                      </div>
                    </div>
                  </div>
